...
CREATE INDEX idx_ficha_tecnica_produto_id ON ficha_tecnica_item(produto_id);
CREATE INDEX idx_ficha_tecnica_insumo_id ON ficha_tecnica_item(insumo_id);
CREATE INDEX idx_movimento_estoque_tenant_id ON movimento_estoque(tenant_id);
