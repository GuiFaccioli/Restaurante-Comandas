    ...
    <AdminPage>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div><p className="text-xs text-muted-foreground">Disponível</p><p className="mt-1 text-lg font-semibold">{formatStockQuantity(item.estoqueAtual, item.unidadeBase)}</p></div>
          <div><p className="text-xs text-muted-foreground">Estoque mínimo</p><p className="mt-1 text-lg font-semibold">{formatStockQuantity(item.estoqueMinimo, item.unidadeBase)}</p></div>
