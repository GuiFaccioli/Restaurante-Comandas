...
## Atualiza��o 2026-06-29 � Permission Gates

- Novo conceito: [permission-gates](concepts/permission-gates.md)
- Autoriza��o centralizada com `requireAccess(access)`.
- Um e-mail representa uma pessoa em uma empresa.
- Server Actions s�o tratadas como superf�cies de API.
- `/cozinha/dashboard` e `/api/events` exigem acesso `cozinha`.
- O app registra pagamentos externos; n�o processa pagamentos.
